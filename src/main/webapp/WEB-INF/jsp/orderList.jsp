        ...
        <div class="row clearfix">
            ...
            <div class="col-md-8 column">
                <ul class="nav nav-pills">
                    ...
                    <li><a href="/lib/stu/borrowList">借书表</a></li>
                    <li class="active"><a href="/lib/stu/orderList">预约表</a></li>
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${orderList}" var="list">
                        <tr>
                            ...
                            <td>
                                <fmt:formatDate value="${list.orderTime}"
                                                pattern="yyyy-MM-dd"/>
                            </td>
                            <td>
                            ...
                            <td>
                                <a class="btn btn-info"
                                   onclick="stu.book.cancelOrder(${list.stuID},${list.bookISBN})">取消预约</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
